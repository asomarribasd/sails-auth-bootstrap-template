...
module.exports = {
    ...
    index: function (req, res) {
        ...
        var enableLocalAuth = true; // sails.config.application_auth.enableLocalAuth;
        var enableTwitterAuth = true; // sails.config.application_auth.enableTwitterAuth;
        var enableFacebookAuth = true; // sails.config.application_auth.enableFacebookAuth;
